...
#ifndef Jaco2ControllerRTC_H
#define Jaco2ControllerRTC_H
...
class Jaco2ControllerRTC : public RTC::DataFlowComponentBase
{
public:
    Jaco2ControllerRTC(RTC::Manager* manager);
    ~Jaco2ControllerRTC();
...
extern "C"
{
    DLL_EXPORT void Jaco2ControllerRTCInit(RTC::Manager* manager);
};
